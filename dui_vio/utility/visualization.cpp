...
void pubOdometry(const DUI_VIO &estimator, const std_msgs::Header &header)
{
...
void pubKeyPoses(const DUI_VIO &estimator, const std_msgs::Header &header)
{
...
void pubTF(const DUI_VIO &estimator, const std_msgs::Header &header)
{
    if( estimator.solver_flag != SolverFlag::NON_LINEAR)
        return;
